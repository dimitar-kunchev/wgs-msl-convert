...
final class WGSMSLTest extends TestCase {
    public function testAll () {
        ...
        $this->assertEqualsWithDelta(580, $msl, 1, 'Computed vs expected MSL differs too much');
        
        $wgs = $conv->MSLToWGS(42.6719739, 23.2886555, 580);
        $this->assertIsFloat($wgs);
        $this->assertEqualsWithDelta(624, $wgs, 1, 'Computed vs expected MSL differs too much');
    }
}